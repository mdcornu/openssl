...
ML_DSA_MATRIX_EXPAND_A_FN matrix_expand_A_scalar;
ML_DSA_VECTOR_EXPAND_S_FN vector_expand_S_scalar;
ML_DSA_VECTOR_EXPAND_MASK_FN vector_expand_mask_scalar;
...
#if defined(KECCAK1600_ASM) && defined(__x86_64__) && !defined(OPENSSL_NO_ASM)
#include "ml_dsa_sample_x86_64.inc"
#else
