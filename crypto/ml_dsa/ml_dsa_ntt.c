...
/* Function pointers - set once during initialization */
static ml_dsa_poly_ntt_fn poly_ntt_impl;
static ml_dsa_poly_ntt_inverse_fn poly_ntt_inverse_impl;
static ml_dsa_poly_ntt_mult_fn poly_ntt_mult_impl;
...
/*
 * AVX2 wrapper functions - adapt assembly interface to POLY* interface.
 */
